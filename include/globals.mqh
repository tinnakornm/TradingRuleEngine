...
int CurrentZone = 0;
int EffectiveBiasLookbackBars = 8;
int EffectiveZoneLookbackBars = 16;
int ZoneFallbackLookbackUsed = 16;
...
TRE_PRESSURE_DECISION_IMPACT PressureDecisionImpact = PRESSURE_IMPACT_NONE;
...
string CandidateDirectionBeforePressure = "NONE";
string DecisionBeforePressure = "WAIT";
string DecisionAfterPressure = "WAIT";
string PressureDecisionImpactText = "NONE";
string RegimeUsedForPressureScopeText = "UNKNOWN";
string PressureScopeAllowedText = "YES";
bool PressureScopeAllowed = true;
int ScoreBeforePressure = 0;
int PressurePenaltyApplied = 0;
int ScoreAfterPressure = 0;
...
string PressureEMAPreviousValueText = "N/A";
string PressureEMASlopePointsText = "N/A";
string PressureDistanceFromEMAPointsText = "N/A";
...
string PressureCalculationStatusText = "NOT CALCULATED";
string MissingPressureDataReasonText = "N/A";
int PressureScore = 0;
...
int EffectivePressureMediumPenalty = 15;
int EffectivePressureHighPenalty = 30;
int EffectivePressureEMAPeriod = 50;
ENUM_TIMEFRAMES EffectivePressureTF = PERIOD_M15;

string PressureExecutionBlockStatusText = "DISABLED";
string PressureExecutionBlockModeText = "SHADOW";
string PressureExecutionBlockCandidateText = "NONE";
string PressureExecutionBlockActionText = "ALLOW";
string PressureExecutionBlockReasonText = "Not evaluated";
string PressureExecutionBlockLastTimeText = "N/A";
bool PressureExecutionBlockApplied = false;
int PressureExecutionBlockTotal = 0;
int PressureExecutionBlockBuyCount = 0;
int PressureExecutionBlockSellCount = 0;
int PressureExecutionBlockHighCount = 0;
int PressureExecutionBlockMediumCount = 0;
...
string ResearchDBStatusText = "DISABLED";
string ResearchDBPathText = "N/A";
string ResearchDBFilenameText = "N/A";
string ResearchDBLastWriteTimeText = "N/A";
string ResearchDBLastErrorText = "N/A";
long ResearchDBExperimentID = 0;
long ResearchDBLastSignalID = 0;
long ResearchDBLastTradeID = 0;
...
int ResearchDBViewDefinitionCount = 0;
string ResearchDBActualViewCreateStatusText = "NOT INITIALIZED";
string ResearchDBLastViewCreateErrorText = "N/A";
int ResearchDBDiagnosticSignalCount = 0;
int ResearchDBDiagnosticExecutedTradeCount = 0;
int ResearchDBDiagnosticBlockedSignalCount = 0;
int ResearchDBDiagnosticSavedLossCount = 0;
int ResearchDBDiagnosticMissedWinCount = 0;
int ResearchDBDiagnosticAttributionErrorCount = 0;
int ResearchDBDiagnosticOrphanSignalCount = 0;
int ResearchDBDiagnosticOrphanTradeCount = 0;
string ResearchDBDiagnosticValidationStatus = "NOT INITIALIZED";
int ResearchAnalyticsWinCount = 0;
int ResearchAnalyticsLossCount = 0;
int ResearchAnalyticsTPCount = 0;
int ResearchAnalyticsSLCount = 0;
int ResearchAnalyticsTimeoutCount = 0;
double ResearchAnalyticsNetProfit = 0;
double ResearchAnalyticsProfitFactor = 0;
double ResearchAnalyticsDrawdown = 0;
double ResearchAnalyticsAverageMAE = 0;
double ResearchAnalyticsAverageMFE = 0;
double ResearchAnalyticsAverageRR = 0;
double ResearchAnalyticsAverageHolding = 0;
double ResearchAnalyticsAverageProfit = 0;
double ResearchAnalyticsAverageLoss = 0;
double ResearchAnalyticsLargestWin = 0;
double ResearchAnalyticsLargestLoss = 0;
int ResearchAnalyticsPressureLowCount = 0;
int ResearchAnalyticsPressureMediumCount = 0;
int ResearchAnalyticsPressureHighCount = 0;
int ResearchAnalyticsPressureUpCount = 0;
int ResearchAnalyticsPressureDownCount = 0;
int ResearchAnalyticsPressureUnknownCount = 0;
int ResearchAnalyticsWatchCount = 0;
int ResearchAnalyticsAllowCount = 0;
int ResearchAnalyticsEpisodeCount = 0;
int ResearchAnalyticsEpisodeTradeCount = 0;
double ResearchAnalyticsEpisodeNetProfit = 0;
